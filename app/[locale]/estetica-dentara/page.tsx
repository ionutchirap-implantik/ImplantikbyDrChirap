...
export async function generateMetadata({ params }: PageProps) {
  ...
  return createScaffoldMetadata(localeParam as Locale, "estetica-dentara", "Estetică dentară", "Dental aesthetics");
}
...
export default async function Page({ params }: PageProps) {
  ...
  const title = locale === "ro" ? "Estetică dentară" : "Dental aesthetics";
