  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "The controller maintains records of processing activities as required by Art. 30 GDPR. Registration with the Romanian National Supervisory Authority for Personal Data Processing (ANSPDCP) is not mandatory for the categories of processing carried out by the clinic under applicable law; data subjects may contact ANSPDCP as set out in section 11.",
      ],
    },
    {
      id: "dpo",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Website security and abuse prevention — anti-spam protection via Cloudflare Turnstile, server-side rate limiting, limited technical logging of IP addresses and security events (basis: Art. 6(1)(f) GDPR — legitimate interest in securing systems). Turnstile processes technical data needed for human verification; the verification token is sent to the Vercel server for validation and is not stored long-term.",
        "Website analytics and improvement — aggregated statistics on site usage via Google Analytics 4, managed through Google Tag Manager (GTM-5QFHBCH), only after consent for analytics cookies (basis: Art. 6(1)(a) GDPR). Consent Mode v2 blocks analytics storage until consent is granted.",
        "Digital marketing and conversion measurement — Google Ads, Meta Pixel, TikTok Pixel, campaign attribution via the `implantik_attribution` cookie, only after consent for marketing cookies (basis: Art. 6(1)(a) GDPR).",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Relevant processors include: (1) Supabase Inc. (USA) — form lead storage, configurable project region; transfers protected by SCCs and supplementary measures; (2) Vercel Inc. (USA) — Next.js site hosting, limited server logs, server-side Turnstile processing; SCCs; (3) Google Ireland Limited / Google LLC (USA/EEA) — GA4, Google Ads, GTM (GTM-5QFHBCH); SCCs and EU-US Data Privacy Framework where applicable; (4) Meta Platforms Ireland Ltd (USA/EEA) — Meta Pixel; SCCs; (5) TikTok Technology Limited (USA/EEA) — TikTok Pixel; SCCs; (6) Cloudflare Inc. (USA) — Turnstile anti-spam; SCCs; (7) Resend Inc. (USA) — lead e-mail notifications, if enabled; SCCs. Processing agreements (DPAs) are entered into or accepted under each provider’s terms.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Leads and requests from forms/website: maximum 24 months from the last relevant interaction, then deletion or anonymisation, except where the request has evolved into a patient relationship.",
        "Medical records and clinical documents: according to applicable medical legislation (including rules on medical records), generally at least 10 years from the last entry or as required for the document type.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Lead storage platform (Supabase): access restricted via server-side keys, Row Level Security policies, encryption in transit (TLS), provider-managed backups, administrative access limited to authorised staff.",
    ...
    },
    {
      ...
      paragraphs: [
        "The implantik.ro website is not intended for children under 18 to independently provide data. The minimum legal age for giving consent in Romania is 18. Medical services for minors may be requested by a parent or legal guardian.",
        "If we learn that we have collected data from a minor under 18 without parental consent where required, we will take steps to delete the data to the extent this does not conflict with medical legal obligations. Age verification relies on voluntarily provided information; for minors’ medical appointments, we require the presence and consent of the legal representative.",
      ],
    },
    {
      id: "changes-contact",
