  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Operatorul păstrează evidența activităților de prelucrare prevăzută de art. 30 GDPR. Înregistrarea la Autoritatea Națională de Supraveghere a Prelucrării Datelor cu Caracter Personal (ANSPDCP) nu este obligatorie pentru categoriile de prelucrări efectuate de clinică în condițiile legii; persoanele vizate pot contacta ANSPDCP conform secțiunii 11.",
      ],
    },
    {
      id: "dpo",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Securitatea site-ului și prevenirea abuzurilor — protecție anti-spam prin Cloudflare Turnstile, rate limiting pe server, jurnalizare tehnică limitată a adreselor IP și a evenimentelor de securitate (temei: art. 6 alin. (1) lit. f) GDPR — interes legitim în securizarea sistemelor). Turnstile procesează date tehnice necesare verificării umane; tokenul de verificare este transmis serverului Vercel pentru validare și nu este stocat pe termen lung.",
        "Analiză și îmbunătățire site — statistici agregate despre utilizarea site-ului prin Google Analytics 4, administrat via Google Tag Manager (GTM-5QFHBCH), doar după consimțământul pentru cookie-uri analitice (temei: art. 6 alin. (1) lit. a) GDPR). Consent Mode v2 blochează stocarea analitică până la acord.",
        "Marketing digital și măsurare conversii — Google Ads, Meta Pixel, TikTok Pixel, atribuire campanii prin cookie-ul `implantik_attribution`, doar după consimțământul pentru cookie-uri de marketing (temei: art. 6 alin. (1) lit. a) GDPR).",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Lista persoanelor împuternicite relevante: (1) Supabase Inc. (SUA) — stocare lead-uri din formulare, regiune configurabilă a proiectului; transferuri protejate prin SCC și măsuri suplimentare; (2) Vercel Inc. (SUA) — hosting site Next.js, jurnale server limitate, procesare Turnstile server-side; SCC; (3) Google Ireland Limited / Google LLC (SUA/SEE) — GA4, Google Ads, GTM (GTM-5QFHBCH); SCC și EU-US Data Privacy Framework, după caz; (4) Meta Platforms Ireland Ltd (SUA/SEE) — Meta Pixel; SCC; (5) TikTok Technology Limited (SUA/SEE) — TikTok Pixel; SCC; (6) Cloudflare Inc. (SUA) — Turnstile anti-spam; SCC; (7) Resend Inc. (SUA) — notificări e-mail lead-uri, dacă este activ; SCC. Contractele de prelucrare (DPA) sunt încheiate sau acceptate conform condițiilor furnizorilor.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Lead-uri și solicitări din formulare/site: maximum 24 de luni de la ultima interacțiune relevantă, apoi ștergere sau anonimizare, cu excepția cazurilor în care solicitarea a evoluat în relație de pacient.",
        "Dosar medical și documente clinice: conform legislației medicale aplicabile (inclusiv normele privind evidența medicală), de regulă minimum 10 ani de la ultima înregistrare sau conform termenelor legale specifice tipului de document.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Platforma de stocare a lead-urilor (Supabase): acces restricționat prin chei server-side, politici Row Level Security, criptare în tranzit (TLS), backup gestionat de furnizor, acces administrativ limitat la personal autorizat.",
    ...
    },
    {
      ...
      paragraphs: [
        "Site-ul implantik.ro nu este destinat în mod direct copiilor sub 18 ani pentru colectarea autonomă de date. Vârsta minimă legală pentru exprimarea consimțământului în România este 18 ani. Serviciile medicale pentru minori pot fi solicitate de un părinte sau tutore legal.",
        "Dacă aflăm că am colectat date de la un minor sub 18 ani fără consimțământul parental acolo unde acesta este necesar, vom lua măsuri pentru ștergerea datelor, în măsura în care nu contravin obligațiilor legale medicale. Verificarea vârstei se bazează pe informațiile furnizate voluntar; pentru programări medicale ale minorilor, solicităm prezența și acordul reprezentantului legal.",
      ],
    },
    {
