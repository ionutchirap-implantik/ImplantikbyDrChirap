...
export const cookiesRo: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Aceste cookie-uri sunt indispensabile pentru: afișarea corectă a paginilor; securitatea formularelor și protecția anti-spam; salvarea alegerilor dvs. privind consimțământul pentru cookie-uri.",
        ...
        "Alte cookie-uri strict necesare: cookie-uri Cloudflare Turnstile (`cf-turnstile-response`, `__cf_bm`) — verificare anti-bot la trimiterea formularelor; durată: sesiune sau până la 30 de zile; temei: art. 6 alin. (1) lit. f) GDPR. Preferința de limbă (ro/en) este gestionată prin rutare URL (`/[locale]`), fără cookie dedicat de limbă. Cookie-ul `implantik_attribution` nu este strict necesar — se setează numai după consimțământ marketing.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Dovada consimțământului: preferințele sunt stocate exclusiv în cookie-ul client `consent-preferences` și în câmpul `policy_version` transmis odată cu formularele de contact. Nu păstrăm un jurnal server-side separat al consimțământului pentru cookie-uri.",
      ],
    },
    {
      id: "retragere",
