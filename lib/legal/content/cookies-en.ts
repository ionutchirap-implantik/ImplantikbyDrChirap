...
export const cookiesEn: LegalDocument = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "Strictly necessary cookies are essential to provide the service requested by the user (site operation, security, language retention) and to remember the choice expressed regarding consent. They do not require consent under applicable law.",
        "Known first-party cookies: `consent-preferences` — stores accepted/refused cookie categories, timestamp, and policy version; duration: up to 12 months.",
        "Other strictly necessary cookies: Cloudflare Turnstile cookies (`cf-turnstile-response`, `__cf_bm`) — anti-bot verification on form submission; duration: session or up to 30 days. Language preference (ro/en) is managed via URL routing (`/[locale]`), without a dedicated language cookie. The `implantik_attribution` cookie is not strictly necessary — it is set only after marketing consent.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "By making a choice in the banner, you confirm that you are at least 16 years old or are acting with the legal representative’s consent.",
        "The choice expressed in the banner is stored together with the date/time it was made and the policy version in force at that moment. When a form is submitted, the consent given is recorded together with the request, with date, time, and policy version, as proof of consent.",
      ],
    },
    {
      id: "withdrawal",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Example content: {\"decided\":true,\"categories\":{\"necessary\":true,\"analytics\":false,\"marketing\":false},\"timestamp\":\"...\",\"policyVersion\":\"2026-06-12\"}. Actual values reflect your choices.",
