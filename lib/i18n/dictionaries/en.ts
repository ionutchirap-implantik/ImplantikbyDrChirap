export const dictionary = {
  ...
  cookie: {
    ...
    description:
      "We use cookies to improve the site and measure our campaigns. Strictly necessary ones always work; the rest — only with your consent. Details in our",
    necessary: "Strictly necessary",
    necessaryDesc: "Essential for navigation, security, and site functionality.",
    analytics: "Analytics",
    analyticsDesc: "Google Analytics (GA4) — helps us understand how the site is used.",
    marketing: "Marketing",
    marketingDesc: "Google Ads, Meta Pixel, TikTok Pixel — measuring advertising campaigns.",
  ...
  contact: {
    ...
    message: "Notes",
    consentBefore:
      "I agree to the processing of my data, including health-related data, in accordance with the",
    consentAfter: "for the purpose of handling my request.",
    consentError: "You must accept data processing to submit your request.",
    submit: "Send",
